        ...
        <div className="p-4 border-t border-border-default bg-surface-muted shrink-0">
            ...
            <div className="grid grid-cols-3 gap-2 mb-2">
                <button 
                    ...
                    className="flex flex-col items-center justify-center gap-1 p-2 text-xs text-fg-muted bg-surface-elevated/60 hover:bg-surface-elevated hover:text-accent rounded-lg border border-border-default hover:border-accent/25 transition-all shadow-sm hover:shadow-sm"
